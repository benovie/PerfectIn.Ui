/**
 * @license AngularJS v1.2.15-build.local+sha.5600d8e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.15-build.local+sha.5600d8e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.15-build.local+sha.5600d8e',    // all of these placeholder strings will be replaced by grunt's
